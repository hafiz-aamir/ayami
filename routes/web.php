...
Route::get('cash-bonus-calculator','HomeController@cash_bonus_calculator')->name('cash-bonus-calculator');
Route::get('how-it-work','HomeController@how_it_work')->name('how-it-work');
...
Route::get('about-ayami','HomeController@about_ayami')->name('about-ayami');
Route::get('founders-and-team-advisor','HomeController@founders_and_team_advisor')->name('founders-and-team-advisor');
Route::get('giving-back','HomeController@giving_back')->name('giving-back');
Route::get('our-business-partners','HomeController@our_business_partners')->name('our-business-partners'); 
...
Route::get('sell-with-ayami','HomeController@sell_with_ayami')->name('sell-with-ayami');
Route::post('post-sell-with-ayami','HomeController@post_sell_with_ayami')->name('post_sell_with_ayami');
...
Route::resource('faqs/faqs', 'faqs\FaqsController');
Route::resource('sell_with_ayami/sell_with_ayami', 'Sell_with_ayami\Sell_with_ayamiController');
Route::resource('sellwithayami/sellwithayami', 'Admin\SellwithayamiController');
Route::resource('localinsight/localinsight', 'Admin\LocalinsightController');
Route::resource('categoryy/categoryy', 'Admin\CategoryyController');
Route::resource('mlslisting/mlslisting', 'mlslisting\MlslistingController');