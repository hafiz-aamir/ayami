...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Faq #{{ $faq->id }}</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{ url('/faqs/faqs') }}">Back</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title" id="basic-layout-form">Faq Info</h4>
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::model($faq, [
                            'method' => 'PATCH',
                            'url' => ['/faqs/faqs', $faq->id],
                            'files' => true
                        ]) !!}

                        @include ('faqs.faqs.form', ['submitButtonText' => 'Update'])
