<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ (request()->is('faqs/faqs') || request()->is('faqs/faqs/*')) ? 'active' : '' }}">
                <a href="{{url('faqs/faqs')}}"><i class="la la-quote-left"></i>
                    <span class="menu-title" data-i18n="eCommerce">FAQ</span>
                </a>
            </li>
            
            
            <!--<li class="nav-item {{ (request()->is('sellwithayami/sellwithayami') || request()->is('sellwithayami/sellwithayami/*')) ? 'active' : '' }}">-->
            <!--    <a href="{{url('sellwithayami/sellwithayami')}}"><i class="la la-quote-left"></i>-->
            <!--        <span class="menu-title" data-i18n="eCommerce">Sell With Ayami</span>-->
            <!--    </a>-->
            <!--</li>-->
            
            
            <li class="nav-item {{ (request()->is('mlslisting/mlslisting') || request()->is('mlslisting/mlslisting/*')) ? 'active' : '' }}">
                <a href="{{url('mlslisting/mlslisting')}}"><i class="la la-quote-left"></i>
                    <span class="menu-title" data-i18n="eCommerce">MLS listing</span>
                </a>
            </li>
